"""
Django settings for jgjfjf_84 project.
...
WSGI_APPLICATION = 'jgjfjf_84.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jgjfjf_84 API",
    "DESCRIPTION": "API documentation for jgjfjf_84 App",
    "VERSION": "v1",
}
